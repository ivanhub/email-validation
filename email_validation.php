 ...
 *
 * @(#) $Header: /opt2/ena/metal/emailvalidation/email_validation.php,v 1.38 2016/10/23 23:07:36 mlemos Exp $
 *
 */
...
{
	var $email_regular_expression="^([-!#\$%&'*+./0-9=?A-Z^_`a-z{|}~])+@([-!#\$%&'*+/0-9=?A-Z^_`a-z{|}~]+\\.)+[a-zA-Z]{2,24}\$";
	var $smtp_validation=1;
	var $timeout=0;
	var $data_timeout=0;
	var $localhost="";
	var $localuser="";
